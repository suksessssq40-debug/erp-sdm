      ...
      <div className="bg-white rounded-[3.5rem] w-full max-w-md p-10 shadow-2xl border border-white/20 animate-in zoom-in duration-300">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            disabled={isSubmitting}
            className={`w-full py-5 text-white rounded-[2rem] font-black uppercase tracking-[0.2em] transition text-[10px] shadow-xl mt-4 flex items-center justify-center gap-2 ${isSubmitting ? 'bg-slate-400 cursor-not-allowed' : 'bg-slate-900 hover:bg-blue-600'}`}
          >
            {isSubmitting ? (
              <>
