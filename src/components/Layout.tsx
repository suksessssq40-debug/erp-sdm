...
const Layout: React.FC<LayoutProps> = ({ 
  ...
  const navItems = [
    ...
    { id: 'kaizen', label: 'Kaizen', icon: Target, roles: [UserRole.OWNER, UserRole.MANAGER, UserRole.FINANCE, UserRole.STAFF] },
  ...
  const visibleNav = navItems.filter(item => {
    ...
    // Special: Kaizen menu only for Kaizen Masters and Owners
    if (item.id === 'kaizen') {
      return !!currentUser?.isKaizenMaster || userRole === UserRole.OWNER || userRole === UserRole.SUPERADMIN;
    }
